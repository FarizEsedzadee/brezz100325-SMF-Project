...
function template_login()
{
	...
	echo '
		<div class="login">
			<div class="cat_bar">
				<h3 style="display:flex; flex-direction: column; justify-content: center; align-items: center; gap: 20px;" class="catbg">
					<span style="color: rgba(255,212,0,0.8);">Giriş yapmak için aşağıdaki alanı doldurunuz!</span>
				</h3>
			</div>
...
function template_admin_login()
{
	...
	// Admin paneline giriş yapmak için gerekli yetkiye sahip olup olmadığını kontrol et
	...
	<form action="', !empty($modSettings['force_ssl']) ? strtr($scripturl, array('http://' => 'https://')) : $scripturl, $context['get_data'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin">
		<div class="login" id="admin_login">
			<div class="cat_bar">
				<h3 style="font-size:18px; color:rgba(255,212,0,0.8); display:flex; flex-direction:column; justify-content: center; align-items: center; gap: 20px;" class="catbg">
				<span style="color: rgba(255,212,0,0.8);">Giriş yapmak için aşağıdaki alanı doldurunuz!</span>
				</h3>
			</div>
