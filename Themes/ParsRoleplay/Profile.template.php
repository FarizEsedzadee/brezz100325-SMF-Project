...
function template_profile_popup()
{
	...
	echo '
		...
		<div class="profile_user_info floatright">
			<span class="profile_username">Hoş geldin <a href="', $scripturl, '?action=profile;u=', $context['user']['id'], '">', $context['user']['name'], '!</a></span>
			<span class="profile_character"><a href="', $scripturl, '?action=characters','">Karakterlerine buradan ulaşabilirsin!</a></span>
	...
	foreach ($context['profile_items'] as $item)
	{
		...
		echo '
				<li><a href="'.$item_url.'">
					', $area['icon'], '<span>', !empty($item['title']) ? $item['title'] : $area['label'], '</span>
					</a>
				</li>';
	}
...
function template_alerts_popup()
{
	...
	else
	{
		...
		{
			echo '
			<div style="display:flex;" class="unread-alerts-wrapper">
