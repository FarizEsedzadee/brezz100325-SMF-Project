...
icon='<span class="'+this.opt.icon_class+'"></span> ';else icon=this.opt.icon?'<img src="'+this.opt.icon+'" class="icon" alt=""> ':'';$('body').append('<div id="'+this.popup_id+'" class="login_popup_container"><div class="'+popup_class+'"><div class="catbg login_popup_heading"><i class="fa-solid fa-arrow-right-to-bracket"></i>'+' '+this.opt.heading+'</div><div class="popup_content">'+this.opt.content+'</div></div></div>');this.popup_body=$('#'+this.popup_id).children('.popup_window');this.popup_body.parent().fadeIn(300);var popup_instance=this;$(document).mouseup(function(e){if($('#'+popup_instance.popup_id).has(e.target).length===0)
...
smc_Toggle.prototype.changeState=function(bCollapse,bInit){bInit=typeof(bInit)!=='undefined';if(!bInit&&bCollapse&&'funcOnBeforeCollapse' in this.opt){this.tmpMethod=this.opt.funcOnBeforeCollapse;this.tmpMethod();delete this.tmpMethod}
...
{dir_elem.disabled=1}
else dir_elem.disabled=!sub_dir.checked};var pingTime=10000;var notificationIcon='/favicon.ico';$(function()
