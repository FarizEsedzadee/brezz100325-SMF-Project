...
/**
 * Tüm üyeler listesini görüntüleyin. Çeşitli sütunlarda sıralama ve silme işlemlerine izin verir
 * seçilen üyeler. Ayrıca tarafından gönderilen arama sorgusunu da işler
 * ?action=admin;area=viewmembers;sa=search.
 * ?action=admin;area=viewmembers;sa=all veya ?action=admin;area=viewmembers;sa=query tarafından çağrılır.
 * moderate_forum izni gerektirir.
 *
 * Standart bir liste kullanır (@see createList())
 */
