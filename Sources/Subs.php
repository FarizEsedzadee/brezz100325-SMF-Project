...
function setupMenuContext()
{
	...
	$context['allow_adminlist'] = allowedTo('view_adminlist');
	...
	if (($menu_buttons = cache_get_data('menu_buttons-' . implode('_', $user_info['groups']) . '-' . $user_info['language'], $cacheTime)) === null || time() - $cacheTime <= $modSettings['settings_updated']) {
		$buttons = array(
			...
			'triangle-exclamation' => array(
				'title' => $txt['rules'],
				'href' => $scripturl . '?board=3.0/#content_section',
				'show' => true,
				'sub_buttons' => array(
				),
				'is_last' => $context['right_to_left'],
			...
			'hammer' => array(
				'title' => $txt['admins'],
				'href' => $scripturl . '?action=adminlist',
			...
			'moderate' => array(
				...
				'show' => allowedTo('moderate_forum'), // Kullanıcı moderatör olmalı
				'style' => 'float:right',
				'sub_buttons' => array(
					'modlog' => array(
					...
					'reported_members' => array(
						...
						'show' => allowedTo('moderate_forum'), // Bu buton da sadece moderatörlere görünsün
					),
				),
			),
	...
	// Otherwise, use the 2012 list of gTLDs and ccTLDs for now and schedule a background update
		...
		if (empty($postapocalypticNightmare)) {
			$smcFunc['db_insert'](
				...
				array('$sourcedir/tasks/UpdateTldRegex.php', 'Update_TLD_Regex', '', 0),
				array()
			);
		}
	}
