...
$txt['pm_unread'] = 'Okunmamış';
$txt['pm_sent_short'] = 'Gönderilen';
$txt['pm_new_short'] = 'Yeni';
$txt['pm_drafts_short'] = 'Taslaklar';
$txt['pm_settings_short'] = 'Ayarlar';
$txt['pm_no_unread'] = 'Okunmamış mesaj yok.';
$txt['pm_was_sent_to_you'] = 'Bir mesaj aldınız.';
$txt['pm_you_were_replied_to'] = 'Bir mesajınıza cevap verildi.';
...
$txt['delete_selected_confirm'] = 'Seçili kişisel iletilerin hepsini silmek istediğinize emin misiniz?';

$txt['sent_to'] = 'Alıcı';
$txt['reply_to_all'] = 'Hepsini Yanıtla';
$txt['delete_conversation'] = 'Sohbeti Sil';
$txt['remove_conversation'] = 'Bu görüşmeye ait tüm mesajları kaldır?';
$txt['pm'] = 'Kişisel mesaj';
...
$txt['pm_too_many_recipients'] = 'Aynı anda %1$d alıcıdan fazla kişiye kişisel ileti gönderemezsiniz.';
...
$txt['pm_remove_all'] = 'Tüm kişisel mesajları sil (bu gelen ve giden kutusundaki tüm mesajlarınızı silecektir).';
$txt['pm_remove_all_warning'] = 'Tüm kişisel mesajlarınızı silmek istediğinizden kesinlikle eminmisiniz? Bu geri döndürülemez!';
$txt['delete_all_prune'] = 'Tümünü sil';
...
$txt['pm_sent_is_replied_to'] = 'Alıcı bu mesaja cevap verdi ya da başka birine yönlendirdi';
...
$txt['pm_search_between'] = 'arasında';
$txt['pm_search_between_and'] = 've';
$txt['pm_search_between_days'] = 'gün arasında';
$txt['pm_search_order'] = 'İleti sıralama şekli';
...
$txt['pm_search_results_info'] = '%2$s için eşleşen %1$d ileti bulundu.';
...
$txt['pm_readable_and'] = '<em>ve</em>';
$txt['pm_readable_or'] = '<em>veya</em>';
...
$txt['pm_remove_message'] = 'Bu mesajı kaldır';
