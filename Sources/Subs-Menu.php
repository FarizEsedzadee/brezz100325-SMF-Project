					...
					if (empty($area['hidden']))
					{
						...
						elseif (isset($area['icon']))
						{
							...
							elseif (file_exists($settings['default_theme_dir'] . '/images/admin/' . $area['icon']))
							{
								...
								$menu_context['sections'][$section_id]['areas'][$area_id]['icon'] = '<span class="' . $area['icon'] . '"></span>';
						}
						else
							$menu_context['sections'][$section_id]['areas'][$area_id]['icon'] = '<span class=" ' . $area_id . '"></span>';
