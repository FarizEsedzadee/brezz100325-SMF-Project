...
function smf_main()
{
	...
	// İşte korkunç $_REQUEST['action'] dizisi - $_REQUEST['action'] => array($file, $function).
	$actionArray = array(
		'adminlist' => array('Adminlist.php', 'Adminlist'),
		...
		'characters' => array('Characters.php', 'CharacterList'),
	...
	// $actionArray'in kolayca değiştirilmesine izin verin.
	call_integration_hook('integrate_actions', array(&$actionArray));

	// Dahil edilecek işlevi ve dosyayı alın - eğer orada değilse, pano dizinini yapın.
	if (!isset($_REQUEST['action']) || !isset($actionArray[$_REQUEST['action']]))
	{
		// Tema ile aksiyonu yakalayın?
	...
	// Aksi takdirde, ayarlandı - bu yüzden bu eyleme gidelim.
